...
export default function SmartBranchCloudControl() {
  ...
  return (
    <aside className={`smart-branch-cloud-control ${state}`} aria-live="polite">
      ...
      <style>{`
        .smart-branch-cloud-control{position:fixed;right:14px;bottom:72px;z-index:490;width:min(430px,calc(100vw - 28px));padding:10px 12px;border:1px solid #9fc5e5;border-radius:14px;background:rgba(246,251,255,.98);box-shadow:0 14px 38px rgba(12,53,88,.2);font-family:Inter,Arial,sans-serif}.smart-branch-cloud-control>div{display:flex;align-items:center;gap:9px;color:#174d78}.smart-branch-cloud-control span{min-width:0}.smart-branch-cloud-control small,.smart-branch-cloud-control strong{display:block}.smart-branch-cloud-control small{font-size:8px;font-weight:950;letter-spacing:.12em}.smart-branch-cloud-control strong{margin-top:3px;font-size:10px;line-height:1.35}.smart-branch-cloud-control button{width:100%;min-height:36px;display:flex;align-items:center;justify-content:center;gap:7px;margin-top:8px;border:0;border-radius:9px;color:#fff;background:#0a66ff;font-size:9px;font-weight:900;cursor:pointer}.smart-branch-cloud-control.success{border-color:#8bc7aa;background:rgba(241,255,248,.96)}.smart-branch-cloud-control.success>div{color:#176747}.smart-branch-cloud-control.error,.smart-branch-cloud-control.signed-out{border-color:#e2a2aa;background:rgba(255,246,247,.98)}.smart-branch-cloud-control.error>div,.smart-branch-cloud-control.signed-out>div{color:#8f2936}.smart-branch-cloud-control.empty{border-color:#b9cfdf;background:rgba(247,251,255,.96)}.smart-branch-cloud-control.empty>div{color:#285674}@media(max-width:700px){.smart-branch-cloud-control{right:10px;bottom:76px;width:calc(100vw - 20px)}}
      `}</style>
    </aside>
  );
}
